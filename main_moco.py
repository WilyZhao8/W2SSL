...
# @Author  : Wily
# @File    : main_moco.py.py
# @Software: PyCharm
#CUDA_VISIBLE_DEVICES=0,1 python main_crop_moco.py -a resnet50 --warmup-epochs 0 --moco-m-cos --crop-min=.2 --dist-url 'tcp://localhost:10140' --multiprocessing-distributed --world-size 1 --rank 0 --print-freq 100 --batch-size 256 --epochs 10  --loss_crop 1.0 /home/user/zhaowenyi/ImageNet100
